# iDEAL plugin for OsCommerce 4.x 
...
Check out the specific installation instructions and tips on https://www.e-plugins.nl/plugin/osCommerce4.x#install

## Troubleshooting

Please see the FAQ on https://www.e-plugins.nl/plugin/osCommerce4.x#help
