...
require_once realpath(dirname(__FILE__) . '/digiwallet/digiwallet.class.php');
...
class digiwallet_bw extends \digiwalletpayment
{
    ...
    {
        global $currencies, $customer_id, $db, $messageStack, $order_totals, $cart_digiwallet_id;
        ...
        tep_redirect(\DigiWalletCore::formatOscommerceUrl(tep_href_link("digiwallet/bankwire?trxid=" . $this->transactionID, '', 'SSL', true, false)));
        exit(0);
    }
}
